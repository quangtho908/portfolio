const AddDependency = {
  body: {
    ...
    type: "object",
    properties: {
      depends_on: { type: "string", examples: ["9hw"] },
      depedency_of: { type: "string" },
    },
        ...
        guest: {
          ...
          properties: {
            user: {
              ...
              type: "object",
              properties: {
                id: { type: "integer", contentEncoding: "int32" },
                username: { type: ["string", "null"] },
                email: { type: "string" },
                color: { type: ["string", "null"] },
                profilePicture: { type: ["string", "null"] },
                initials: { type: "string" },
                role: { type: "integer", contentEncoding: "int32" },
                ...
                folders: {
                  ...
                  items: {
                    ...
                    properties: {
                      id: { type: "string" },
                      name: { type: "string" },
                      orderindex: { type: "integer", contentEncoding: "int32" },
        ...
        task: {
          ...
          properties: {
            ...
            linked_tasks: {
              ...
              items: {
                title: "LinkedTask",
                required: ["task_id", "link_id", "date_created", "userid"],
                type: "object",
                properties: {
                  task_id: { type: "string" },
                  link_id: { type: "string" },
...
const Addtagsfromtimeentries = {
  body: {
    title: "Addtagsfromtimeentriesrequest",
    required: ["time_entry_ids", "tags"],
    type: "object",
    properties: {
      time_entry_ids: {
        type: "array",
        items: { type: "string", examples: ["timer_id"] },
        description: "",
      },
      tags: {
        type: "array",
        items: {
          ...
          type: "object",
          properties: {
            name: { type: "string", examples: ["name of tag"] },
            tag_fg: { type: "string", examples: ["#FFFFFF"] },
            tag_bg: { type: "string", examples: ["#BF55EC"] },
          },
        },
        description: "",
      },
...
const Changetagnamesfromtimeentries = {
  body: {
    title: "Changetagnamesfromtimeentriesrequest",
    required: ["name", "new_name", "tag_bg", "tag_fg"],
    type: "object",
    properties: {
      name: { type: "string", examples: ["old tag name"] },
      new_name: { type: "string", examples: ["new tag name"] },
      tag_bg: { type: "string", examples: ["#000000"] },
      tag_fg: { type: "string", examples: ["#000000"] },
    },
    $schema: "https://json-schema.org/draft/2020-12/schema",
  },
  metadata: {
        ...
        data: {
          ...
          properties: {
            ...
            parent: {
              ...
              type: "object",
              required: ["id", "type"],
              properties: { id: { type: "string" }, type: { type: "number" } },
            },
            creator: {
              type: "string",
            ...
            updated_at: {
              type: "string",
              description:
                "Timestamp of the last update in this Channel - Deprecated in favor of latest_comment_at",
              deprecated: true,
            },
            workspace_id: {
              type: "string",
            ...
            latest_comment_at: {
              type: "string",
              description:
                "Timestamp of the last comment in this Channel. Optional in the case of a new Channel with no comments yet",
            },
            ...
            is_hidden: {
              type: "boolean",
              description:
                "Has the user hidden this Channel from their sidebar? Currently only an option for DM/Group DM.",
            },
            default_view: {
              description:
                "Data about the default view that the Channel should open in",
              type: "object",
              required: ["type", "view_id", "standard"],
              properties: {
                type: { type: "number" },
                view_id: { type: "string" },
                ...
                _version_vector: {
                  ...
                  properties: {
                    ...
                    vector: {
                      ...
                      items: {
                        type: "object",
                        required: ["master_id", "version", "deleted"],
                        properties: {
            ...
            chat_room_category: {
              type: "string",
              description:
                "The category of the Channel, e.g. a welcome channel, (in the future, maybe) a ClickBot channel, etc.\n\n`WELCOME_CHANNEL`",
              enum: ["WELCOME_CHANNEL"],
            },
            links: {
              description: "The links to elements of the Channel.",
              type: "object",
              required: ["members", "followers"],
              properties: {
                members: {
                  type: "string",
    ...
    default: {
      ...
      properties: {
        ...
        message: {
          ...
          examples: ["Generic error message"],
        },
        trace_id: {
          type: "integer",
          description:
        ...
        timestamp: {
          ...
          examples: [1671534256138],
        },
      },
      required: ["status", "message", "trace_id", "timestamp"],
      $schema: "https://json-schema.org/draft/2020-12/schema",
    },
  },
} as const;
    ...
    properties: {
      ...
      reactions: {
        ...
        items: {
          ...
          required: ["date", "reaction", "user_id"],
        },
        maxItems: 10,
      },
      followers: {
    ...
    "201": {
      ...
      properties: {
        ...
        links: {
          ...
          type: "object",
          required: ["reactions", "replies", "tagged_users"],
          properties: {
            reactions: {
              type: "string",
...
const CreateChatViewComment = {
  body: {
    title: "CreateChatViewCommentrequest",
    required: ["comment_text", "notify_all"],
    type: "object",
    properties: {
      comment_text: { type: "string", examples: ["View comment content"] },
      notify_all: {
        description:
...
const CreateChecklist = {
  body: {
    ...
    required: ["name"],
    type: "object",
    properties: { name: { type: "string", examples: ["Checklist"] } },
    $schema: "https://json-schema.org/draft/2020-12/schema",
  },
  metadata: {
    allOf: [
      ...
      properties: {
        checklist: {
          ...
          properties: {
            ...
            name: { type: "string" },
            orderindex: { type: "integer", contentEncoding: "int32" },
            resolved: { type: "integer", contentEncoding: "int32" },
            unresolved: { type: "integer", contentEncoding: "int32" },
            items: {
              type: "array",
              items: { type: "string" },
              description: "",
...
const CreateChecklistItem = {
  body: {
    ...
    type: "object",
    properties: {
      name: { type: "string", examples: ["Checklist Item"] },
      assignee: { type: "integer", contentEncoding: "int32", examples: [183] },
    },
    $schema: "https://json-schema.org/draft/2020-12/schema",
  },
  metadata: {
  ...
  body: {
    ...
    properties: {
      user_ids: {
        type: "array",
        description:
          "The unique user IDs of participants in the Direct Message, up to 10. A Self DM is created when no user IDs are provided",
        items: { type: "string" },
        maxItems: 10,
        uniqueItems: true,
      },
...
const CreateDoc = {
  body: {
    type: "object",
    properties: {
      name: { type: "string", description: "The name of the new Doc." },
      parent: {
...
const CreateFolder = {
  body: {
    ...
    required: ["name"],
    type: "object",
    properties: { name: { type: "string", examples: ["New Folder Name"] } },
    $schema: "https://json-schema.org/draft/2020-12/schema",
  },
  metadata: {
    allOf: [
...
const CreateFolderFromTemplate = {
    ...
    properties: {
      ...
      options: {
        ...
        properties: {
          ...
          include_views: { type: "boolean", description: "Import views" },
          old_due_date: {
            type: "boolean",
          ...
          old_tags: { type: "boolean", description: "Import tasks tags" },
          old_statuses: {
            type: "boolean",
            description: "Import tasks status settings",
          },
          subtasks: { type: "boolean", description: "Import tasks subtasks" },
          custom_type: { type: "boolean", description: "Import tasks types" },
          old_assignees: {
            type: "boolean",
          ...
          comment: { type: "boolean", description: "Import tasks comments" },
          old_status: {
            type: "boolean",
          ...
          priority: { type: "boolean", description: "Import tasks priority" },
          custom_fields: {
            type: "boolean",
  ...
  response: {
    ...
    "400": {
      type: "object",
      properties: {
        error: { type: "string", examples: ["Name is required"] },
        ECODE: { type: "string", examples: ["OAUTH_119"] },
      },
      $schema: "https://json-schema.org/draft/2020-12/schema",
    },
  },
} as const;
const CreateFolderListFromTemplate = {
  body: {
    type: "object",
    required: ["name"],
    properties: {
  ...
  response: {
        ...
        list: {
          ...
          properties: {
            ...
            space: {
              ...
              properties: {
                id: {
                  ...
                  examples: ["90112667046"],
                },
                name: {
                  type: "string",
                  description: "Display name of the Space",
                  examples: ["API Test Space"],
                },
                access: {
                  type: "boolean",
                  description:
            ...
            inbound_address: {
              ...
              examples: ["abc-list@tasks.clickup.com"],
            },
            archived: {
              type: "boolean",
              ...
              items: {
                ...
                properties: {
                  id: {
                    ...
                    examples: ["sc901107394085_DCnaeiSB"],
                  },
                  status: {
                    type: "string",
    ...
    "400": {
      ...
      properties: {
        error: { type: "string", examples: ["Name is required"] },
        ECODE: { type: "string", examples: ["OAUTH_117"] },
      },
      $schema: "https://json-schema.org/draft/2020-12/schema",
    },
  },
...
const CreateFolderView = {
  body: {
    ...
    type: "object",
    properties: {
      name: { type: "string", examples: ["New Folder View Name"] },
      type: {
        type: "string",
        description:
      ...
      settings: {
        ...
        type: "object",
        properties: {
          show_task_locations: { type: "boolean" },
          show_subtasks: {
            description:
          ...
          show_subtask_parent_names: { type: "boolean" },
          show_closed_subtasks: { type: "boolean" },
          show_assignees: { type: "boolean", examples: [true] },
          show_images: { type: "boolean", examples: [true] },
          collapse_empty_columns: { type: ["string", "null"] },
          me_comments: { type: "boolean", examples: [true] },
          me_subtasks: { type: "boolean", examples: [true] },
          me_checklists: { type: "boolean", examples: [true] },
        },
      },
    },
    $schema: "https://json-schema.org/draft/2020-12/schema",
          ...
          properties: {
            ...
            settings: {
              ...
              properties: {
                ...
                collapse_empty_columns: { type: ["string", "null"] },
                me_comments: { type: "boolean" },
                me_subtasks: { type: "boolean" },
                me_checklists: { type: "boolean" },
              },
            },
          },
        },
...
const CreateFolderlessList = {
  body: {
    title: "CreateFolderlessListrequest",
    required: ["name"],
    type: "object",
    properties: {
      name: { type: "string", examples: ["New List Name"] },
      content: { type: "string", examples: ["New List Content"] },
      markdown_content: {
        type: "string",
        description:
          "Use `markdown_content` instead of `content` to format your List description.",
        examples: ["# This is markdown\n ***bold and italicized text***"],
      },
      due_date: {
        type: "integer",
        contentEncoding: "int64",
        examples: [1567780450202],
      },
      due_date_time: { type: "boolean" },
      priority: { type: "integer", contentEncoding: "int32", examples: [1] },
      assignee: {
...
const CreateGoal = {
  body: {
    ...
    type: "object",
    properties: {
      name: { type: "string", examples: ["Goal Name"] },
      due_date: {
        type: "integer",
        contentEncoding: "int64",
        examples: [1568036964079],
      },
      description: { type: "string", examples: ["Goal Description"] },
      multiple_owners: { type: "boolean", examples: [true] },
      owners: {
        type: "array",
        items: { type: "integer", contentEncoding: "int32", examples: [183] },
        description: "Array of user IDs.",
      },
      color: { type: "string", examples: ["#32a852"] },
    },
    $schema: "https://json-schema.org/draft/2020-12/schema",
  },
  metadata: {
      ...
      properties: {
        goal: {
          ...
          properties: {
            ...
            archived: { type: "boolean" },
            creator: { type: "integer", contentEncoding: "int32" },
            color: { type: "string" },
            ...
            percent_completed: { type: "integer", contentEncoding: "int32" },
            history: {
              type: "array",
              items: { type: "string" },
              description: "",
...
const CreateKeyResult = {
  body: {
    ...
    type: "object",
    properties: {
      name: { type: "string", examples: ["New Key Result Name"] },
      owners: {
        type: "array",
        items: { type: "integer", contentEncoding: "int32", examples: [183] },
        description: "",
      ...
      steps_start: { type: "integer", contentEncoding: "int32" },
      steps_end: { type: "integer", contentEncoding: "int32", examples: [10] },
      unit: { type: "string", examples: ["km"] },
      task_ids: {
        description:
      ...
      properties: {
        key_result: {
          ...
          properties: {
            ...
            percent_completed: { type: ["string", "null"] },
            ...
            last_action: {
              ...
              properties: {
                ...
                userid: { type: "integer", contentEncoding: "int32" },
...
const CreateListComment = {
  body: {
    title: "CreateListCommentrequest",
    required: ["comment_text", "assignee", "notify_all"],
    type: "object",
    properties: {
      comment_text: { type: "string", examples: ["List comment content"] },
      assignee: { type: "integer", contentEncoding: "int32", examples: [183] },
      notify_all: {
        description:
          "If `notify_all` is true, notifications will be sent to everyone including the creator of the comment.",
...
const CreateListView = {
  body: {
    ...
    type: "object",
    properties: {
      name: { type: "string", examples: ["New List View Name"] },
      type: {
        type: "string",
        description:
          "The type of view to create. Options include: `list`, `board`, `calendar`, `table`, `timeline`, `workload`, `activity`, `map`, `conversation`, or `gantt`.",
...
const CreateLocationChatChannel = {
  body: {
    type: "object",
    properties: {
      description: {
      ...
      location: {
        ...
        properties: {
          id: {
            type: "string",
            description:
              "The ID of the hierarchy entity where the Channel is to be located",
          },
          type: {
            type: "string",
            description:
              "The type of the location. Must be a Space, Folder, or List.",
            enum: ["folder", "list", "space"],
          },
        },
      },
    },
  ...
  response: {
    "200": {
      type: "object",
      description:
        "The existing location Channel that is matching the creation request.",
      properties: {
        data: {
          type: "object",
          properties: {
...
const CreatePage = {
  body: {
    ...
    properties: {
      ...
      content: { type: "string", description: "The content of the new page." },
      content_format: {
        type: "string",
        description:
  ...
  response: {
    "201": {
      ...
      properties: {
        ...
        contributors: { type: "array", items: { type: "number" } },
        cover: {
          type: "object",
          properties: {
            color: { type: "string" },
    ...
    "201": {
      ...
      properties: {
        ...
        links: {
          description: "The links to elements of the message.",
          type: "object",
          required: ["reactions", "tagged_users"],
          properties: {
            reactions: {
              type: "string",
              description: "The link to the reactions of this message.",
...
const CreateSpace = {
  body: {
    ...
    required: ["name", "multiple_assignees", "features"],
    type: "object",
    properties: {
      name: { type: "string", examples: ["New Space Name"] },
      multiple_assignees: { type: "boolean", examples: [true] },
      features: {
        title: "Features",
        required: [
          "due_dates",
        ...
        properties: {
          due_dates: {
            ...
            properties: {
              ...
              remap_due_dates: { type: "boolean", examples: [true] },
          ...
          tags: {
            ...
            required: ["enabled"],
            type: "object",
            properties: { enabled: { type: "boolean", examples: [true] } },
          },
          time_estimates: {
            title: "TimeEstimates",
            required: ["enabled"],
...
const CreateSpaceListFromTemplate = {
  body: {
    type: "object",
    required: ["name"],
    properties: {
  ...
  body: {
    ...
    properties: {
      tag: {
        ...
        type: "object",
        properties: {
          name: { type: "string", examples: ["Tag Name"] },
          tag_fg: { type: "string", examples: ["#000000"] },
          tag_bg: { type: "string", examples: ["#000000"] },
        },
      },
...
const CreateSpaceView = {
  body: {
    ...
    type: "object",
    properties: {
      name: { type: "string", examples: ["New Space View Name"] },
      type: {
        type: "string",
        description:
          "The type of view to create. Options include: `list`, `board`, `calendar`, `table`, `timeline`, `workload`, `activity`, `map`, `conversation`, or `gantt`.",
...
const CreateTask = {
  body: {
    ...
    type: "object",
    properties: {
      name: { type: "string", examples: ["New Task Name"] },
      description: { type: "string", examples: ["New Task Description"] },
      assignees: {
        type: "array",
        items: { type: "integer", contentEncoding: "int32", examples: [183] },
        description: "",
      ...
      group_assignees: {
        ...
        items: {
          type: "string",
          examples: ["dd01f92f-48ca-446d-88a1-0beb0e8f5f14"],
        },
        description: "Assign multiple user groups to the task.",
      },
      tags: {
        type: "array",
        items: { type: "string", examples: ["tag name 1"] },
        description: "",
      },
      ...
      custom_fields: {
        ...
        items: {
          ...
          properties: {
            id: {
              type: "string",
              examples: ["0a52c486-5f05-403b-b4fd-c512ff05131c"],
            },
            value: {
              oneOf: [
              ...
              examples: ["This is a string of text added to a Custom Field."],
            },
          },
        },
          ...
          items: {
            ...
            properties: {
              ...
              type_config: {
                ...
                type: "object",
                properties: {
                  single_user: { type: "boolean" },
                  include_groups: { type: "boolean" },
                  include_guests: { type: "boolean" },
                  include_team_members: { type: "boolean" },
                },
              },
              date_created: { type: "string" },
...
const CreateTaskAttachment = {
  body: {
    properties: { attachment: { type: "array", items: {} } },
    type: "object",
    $schema: "https://json-schema.org/draft/2020-12/schema",
  },
  metadata: {
...
const CreateTaskComment = {
  body: {
    ...
    type: "object",
    properties: {
      comment_text: { type: "string", examples: ["Task comment content"] },
      assignee: { type: "integer", contentEncoding: "int32", examples: [183] },
      group_assignee: {
        type: "string",
        contentEncoding: "int32",
...
const CreateTaskFromTemplate = {
  body: {
    ...
    required: ["name"],
    type: "object",
    properties: { name: { type: "string", examples: ["New task name"] } },
    $schema: "https://json-schema.org/draft/2020-12/schema",
  },
  metadata: {
    allOf: [
...
const CreateTeamView = {
  body: {
    ...
    type: "object",
    properties: {
      name: { type: "string", examples: ["New Everything level View"] },
      type: {
        type: "string",
        description:
          "The type of view to create. Options include: `list`, `board`, `calendar`, `table`, `timeline`, `workload`, `activity`, `map`, `conversation`, or `gantt`.",
  ...
  body: {
    ...
    properties: {
      ...
      group_assignee: {
        ...
        contentEncoding: "int32",
        description: "",
        examples: ["d01f92f-48ca-446d-88a1-0beb0e8f5f14"],
      },
      notify_all: {
        description:
          "If `notify_all` is true, notifications will be sent to everyone including the creator of the comment.",
...
const CreateUserGroup = {
  body: {
    ...
    type: "object",
    properties: {
      name: { type: "string", examples: ["New User Group name"] },
      handle: { type: "string", examples: ["newusergroupname"] },
      members: {
        type: "array",
        items: {
          type: "integer",
...
const CreateWebhook = {
  body: {
    ...
    properties: {
      endpoint: {
        type: "string",
        examples: ["https://yourdomain.com/webhook"],
      },
      events: {
        type: "array",
        description:
          "See [documentation](doc:webhooks#task-webhooks) for available event options. Use `*` to subscribe to all events.",
        items: { type: "string", examples: ["taskCreated"] },
      },
      space_id: { type: "integer", examples: [1234] },
      folder_id: { type: "integer", examples: [5678] },
      list_id: { type: "integer", examples: [9876] },
      task_id: { type: "string", examples: ["abc1234"] },
    },
    $schema: "https://json-schema.org/draft/2020-12/schema",
  },
  metadata: {
      ...
      properties: {
        ...
        webhook: {
          ...
          properties: {
            id: { type: "string" },
            userid: { type: "integer", contentEncoding: "int32" },
            team_id: { type: "integer", contentEncoding: "int32" },
            ...
            health: {
              ...
              properties: {
                status: { type: "string" },
                fail_count: { type: "integer", contentEncoding: "int32" },
              },
            },
            secret: { type: "string" },
          },
...
const Createatimeentry = {
  body: {
    title: "Createatimeentryrequest",
    required: ["start", "duration"],
    type: "object",
    properties: {
      description: { type: "string", examples: ["from api"] },
      tags: {
        description:
      ...
      end: { type: "integer", contentEncoding: "int64" },
      billable: { type: "boolean", examples: [true] },
      duration: {
        description:
      ...
      tid: { type: "string", examples: ["task_id"] },
    },
    $schema: "https://json-schema.org/draft/2020-12/schema",
  },
  metadata: {
  ...
  response: {
    "200": {
      ...
      properties: {
        ...
        start: { type: "integer", contentEncoding: "int64" },
        billable: { type: "boolean" },
        duration: { type: "integer", contentEncoding: "int32" },
        assignee: { type: "integer", contentEncoding: "int32" },
        tid: { type: "string" },
      },
      $schema: "https://json-schema.org/draft/2020-12/schema",
    },
  ...
  metadata: {
    allOf: [
      ...
      },
      {
        ...
        required: ["depends_on", "dependency_of"],
      },
    ],
  },
  response: {
      ...
      properties: {
        data: {
          ...
          properties: {
            ...
            tags: { type: "array", items: { type: "string" }, description: "" },
            source: { type: "string" },
            at: { type: "integer", contentEncoding: "int64" },
          },
        },
      },
      $schema: "https://json-schema.org/draft/2020-12/schema",
...
const EditChecklist = {
  body: {
    ...
    type: "object",
    properties: {
      name: { type: "string", examples: ["Updated Checklist"] },
      position: {
        description:
...
const EditChecklistItem = {
  body: {
    ...
    type: "object",
    properties: {
      name: { type: "string", examples: ["Updated Checklist Item"] },
      assignee: { type: ["string", "null"] },
      resolved: { type: "boolean", examples: [true] },
      parent: {
        description:
...
const EditGuestOnWorkspace = {
  body: {
    title: "EditGuestOnWorkspacerequest",
    type: "object",
    properties: {
      can_see_points_estimated: { type: "boolean", examples: [true] },
      can_edit_tags: { type: "boolean", examples: [true] },
      can_see_time_spent: { type: "boolean", examples: [true] },
      can_see_time_estimated: { type: "boolean", examples: [true] },
      can_create_views: { type: "boolean", examples: [true] },
      custom_role_id: {
        type: "integer",
        contentEncoding: "int32",
        examples: [12345],
...
const EditKeyResult = {
  body: {
    ...
    properties: {
      ...
      note: { type: "string", examples: ["Target achieved"] },
    },
    $schema: "https://json-schema.org/draft/2020-12/schema",
  },
  metadata: {
          ...
          properties: {
            ...
            last_action: {
              ...
              properties: {
                ...
                steps_current_float: { type: ["string", "null"] },
              },
            },
          },
        },
...
const EditPage = {
  body: {
    type: "object",
    properties: {
      name: { type: "string", description: "The updated name of the page." },
      sub_title: {
        type: "string",
...
const EditUserOnWorkspace = {
  body: {
    title: "EditUserOnWorkspacerequest",
    required: ["username", "admin", "custom_role_id"],
    type: "object",
    properties: {
      username: { type: "string", examples: ["User Name"] },
      admin: { type: "boolean" },
      custom_role_id: {
        type: "integer",
        contentEncoding: "int32",
...
const Edittimetracked = {
  body: {
    ...
    properties: {
      ...
      time: { type: "integer", contentEncoding: "int32", examples: [8640000] },
    },
    $schema: "https://json-schema.org/draft/2020-12/schema",
  },
  metadata: {
  ...
  body: {
    ...
    properties: {
      client_id: {
        ...
        examples: ["your_client_id"],
      },
      client_secret: {
        type: "string",
        description: "OAuth app client secret",
        examples: ["your_client_secret"],
      },
      code: {
        type: "string",
...
const GetAccessibleCustomFields = {
  metadata: {
    allOf: [
      {
        type: "object",
            ...
            properties: {
              ...
              type_config: {
                ...
                properties: {
                  options: {
                    ...
                    items: {
                      ...
                      properties: {
                        ...
                        color: { type: ["string", "null"] },
                        name: { type: "string" },
                        value: { type: "integer", contentEncoding: "int32" },
                        type: { type: "string" },
                        orderindex: {
                          type: "integer",
                          contentEncoding: "int32",
                  ...
                  precision: { type: "integer", contentEncoding: "int32" },
                  ...
                  complete_on: { type: "integer", contentEncoding: "int32" },
                },
              },
              date_created: { type: "string" },
              hide_from_guests: { type: "boolean" },
...
const GetBulkTasksTimeinStatus = {
  metadata: {
    allOf: [
      {
        type: "object",
  ...
  response: {
    "200": {
      ...
      required: ["27075wz", "20bbn28"],
      type: "object",
      properties: {
        "27075wz": {
          title: "27075wz",
          required: ["current_status", "status_history"],
          type: "object",
          properties: {
            current_status: {
              title: "CurrentStatus",
              required: ["status", "color", "total_time"],
              type: "object",
              properties: {
                status: { type: "string" },
                color: { type: "string" },
                total_time: {
                  title: "TotalTime",
                  required: ["by_minute", "since"],
                  type: "object",
                  properties: {
                    by_minute: { type: "integer", contentEncoding: "int32" },
                    since: { type: "string" },
                  },
                },
              },
        ...
        data: {
          ...
          items: {
            ...
            properties: {
              ...
              username: { type: "string", description: "Userame of the user." },
            },
          },
        },
      },
      ...
      },
      {
        ...
        properties: {
          ...
          with_comment_since: {
            ...
            $schema: "https://json-schema.org/draft/2020-12/schema",
            description:
              "Only return Channels with comments since the given timestamp",
          },
          room_types: {
            type: "array",
            items: { type: "string", enum: ["CHANNEL", "DM", "GROUP_DM"] },
            $schema: "https://json-schema.org/draft/2020-12/schema",
        ...
        data: {
          ...
          items: {
            ...
            properties: {
              ...
              counts: {
                description:
                  "Counts relevant to the user requesting the Channel",
                type: "object",
                required: [
                  "parent_id",
                  "parent_type",
...
const GetChatMessages = {
  ...
  response: {
    "200": {
      ...
      required: ["next_cursor"],
      description:
        "The list of top level messages in the Channel, most recent first.",
      properties: {
        next_cursor: {
          type: "string",
          description: "The next cursor to use for pagination.",
        ...
        custom_items: {
          ...
          items: {
            ...
            properties: {
              ...
              name: { type: "string", description: "Custom task type name." },
              name_plural: {
                type: "string",
        ...
        custom_roles: {
          ...
          items: {
            ...
            properties: {
              ...
              team_id: { type: "string" },
              name: { type: "string" },
              inherited_role: { type: "integer", contentEncoding: "int32" },
              date_created: { type: "string" },
              members: {
                type: "array",
                items: { type: "integer", contentEncoding: "int32" },
                description: "",
              },
            },
          },
  ...
  response: {
    "200": {
      ...
      items: {
          ...
          pages: {
            ...
            items: {
              ...
              properties: {
                ...
                pages: {
                  description:
                    "More nested documents witht the same object structure.",
                  type: "array",
                  items: {},
                },
              },
        ...
        required: ["id", "doc_id", "workspace_id", "name"],
      },
      $schema: "https://json-schema.org/draft/2020-12/schema",
    },
  },
      ...
      items: {
        ...
        properties: {
          ...
          pages: {
            type: "array",
            description:
              "More nested documents with the same object structure.",
            items: {},
          },
          sub_title: { type: "string" },
          date_created: { type: "number" },
        ...
        tasks: {
          ...
          items: {
            ...
            properties: {
              ...
              parent: { type: "string" },
              priority: { type: "integer", contentEncoding: "int32" },
              due_date: { type: "string" },
              ...
              custom_fields: {
                ...
                items: {
                  ...
                  properties: {
                    ...
                    name: { type: "string" },
                    type: { type: "string" },
                    type_config: { type: "object", additionalProperties: true },
                    date_created: { type: "string" },
                    hide_from_guests: { type: "boolean" },
                    required: { type: "boolean" },
                  },
  ...
  response: {
    "200": {
      ...
      properties: {
        ...
        task_count: { type: "string" },
        lists: { type: "array", items: { type: "string" }, description: "" },
      },
      $schema: "https://json-schema.org/draft/2020-12/schema",
    },
  },
} as const;
const GetFolderAvailableFields = {
  metadata: {
    allOf: [
      {
        type: "object",
        ...
        goals: {
          ...
          items: {
            ...
            properties: {
              ...
              key_result_count: { type: "integer", contentEncoding: "int32" },
              members: {
                type: "array",
                items: {
                  title: "Member1",
        ...
        folders: {
          ...
          items: {
            ...
            properties: {
              ...
              date_created: { type: "string" },
              creator: { type: "integer", contentEncoding: "int32" },
              goal_count: { type: "integer", contentEncoding: "int32" },
              members: {
                type: "array",
                items: {
                  title: "Member2",
                  ...
                  properties: {
                    ...
                    color: { type: "string" },
                    permission_level: { type: "string" },
                    date_added: { type: "integer", contentEncoding: "int64" },
                    added_by: { type: "integer", contentEncoding: "int32" },
                    initials: { type: "string" },
                    profilePicture: { type: "string" },
                  },
                },
  ...
  response: {
    "200": {
      ...
      properties: {
        ...
        watchers: { type: "array", items: { type: "string" }, description: "" },
        checklists: {
          type: "array",
          items: { type: "string" },
          description: "",
        ...
        attachments: {
          ...
          items: {
            ...
            properties: {
              ...
              parent_id: { type: "string" },
              size: { type: "bigint" },
              total_comments: { type: "int" },
              resolved_comments: { type: "int" },
              user: {
                title: "User2",
                required: [
                  "id",
    ...
    "200": {
      ...
      properties: {
        ...
        status_history: {
          ...
          items: {
            title: "StatusHistory",
            required: ["status", "color", "type", "total_time", "orderindex"],
            type: "object",
            properties: {
              status: { type: "string" },
              color: { type: "string" },
    ...
    allOf: [
      {
        ...
        properties: {
          ...
          group_ids: {
            type: "string",
            examples: ["C9C58BE9-7C73-4002-A6A9-310014852858"],
            $schema: "https://json-schema.org/draft/2020-12/schema",
            description:
    ...
    "200": {
      ...
      properties: {
        members: {
          ...
          type: "object",
          properties: {
            filled_members_seats: { type: "integer", contentEncoding: "int32" },
            total_member_seats: { type: "integer", contentEncoding: "int32" },
            empty_member_seats: { type: "integer", contentEncoding: "int32" },
          },
        },
        guests: {
          title: "Guests",
          ...
          type: "object",
          properties: {
            filled_guest_seats: { type: "integer", contentEncoding: "int32" },
            total_guest_seats: { type: "integer", contentEncoding: "int32" },
            empty_guest_seats: { type: "integer", contentEncoding: "int32" },
          },
        },
      },
      $schema: "https://json-schema.org/draft/2020-12/schema",
...
const Getalltagsfromtimeentries = {
  metadata: {
    allOf: [
      {
        type: "object",
    ...
    "200": {
      ...
      properties: {
        data: {
          ...
          items: {
            title: "Data1",
            required: ["name", "creator", "tag_bg", "tag_fg"],
            type: "object",
            properties: {
              name: { type: "string" },
              creator: { type: "integer", contentEncoding: "int32" },
        ...
        data: {
          ...
          properties: {
            ...
            task_location: {
              ...
              type: "object",
              properties: {
                list_id: { type: "integer", contentEncoding: "int32" },
                folder_id: { type: "integer", contentEncoding: "int32" },
                space_id: { type: "integer", contentEncoding: "int32" },
...
const Gettimeentrieswithinadaterange = {
  metadata: {
    allOf: [
      {
        type: "object",
        ...
        data: {
          ...
          items: {
            ...
            properties: {
              ...
              time: { type: "integer", contentEncoding: "int32" },
              intervals: {
                type: "array",
                items: {
                  title: "Interval",
...
const InviteGuestToWorkspace = {
  body: {
    title: "InviteGuestToWorkspacerequest",
    required: ["email"],
    type: "object",
    properties: {
      email: { type: "string", examples: ["guest@example.com"] },
      can_edit_tags: { type: "boolean", examples: [true] },
      can_see_time_spent: { type: "boolean", examples: [true] },
      can_see_time_estimated: { type: "boolean", examples: [true] },
      can_create_views: { type: "boolean", examples: [true] },
...
const InviteUserToWorkspace = {
  body: {
    ...
    properties: {
      ...
      admin: { type: "boolean", examples: [true] },
      custom_role_id: { type: "integer", contentEncoding: "int32" },
    },
    $schema: "https://json-schema.org/draft/2020-12/schema",
  },
  metadata: {
      ...
      properties: {
        ...
        links: {
          ...
          oneOf: [
            {
              type: "object",
              required: ["replies", "tagged_users", "reactions"],
              properties: {
                reactions: {
                  type: "string",
                  description: "The link to the reactions of this message.",
            ...
            {
              type: "object",
              required: ["tagged_users", "reactions"],
              properties: {
                reactions: {
                  type: "string",
                  description: "The link to the reactions of this message.",
...
const RemoveGuestFromWorkspace = {
  metadata: {
    allOf: [
      {
        type: "object",
...
const Removetagsfromtimeentries = {
  body: {
    ...
    properties: {
      ...
      tags: {
        ...
        items: {
          ...
          required: ["name"],
          type: "object",
          properties: { name: { type: "string", examples: ["name of tag"] } },
        },
        description: "",
      },
    },
    ...
    anyOf: [
      {
        ...
        required: ["value"],
        properties: {
          value: { type: "string", examples: ["https://clickup.com/api"] },
        },
      },
      {
        type: "object",
        ...
        required: ["value"],
        properties: { value: { type: "string", examples: ["uuid1234"] } },
      },
      {
        type: "object",
        ...
        required: ["value"],
        properties: {
          value: { type: "string", examples: ["user@company.com"] },
        },
      },
      {
        type: "object",
        ...
        required: ["value"],
        properties: {
          value: { type: "string", examples: ["+1 123 456 7890"] },
        },
      },
      {
        type: "object",
        ...
        properties: {
          ...
          value_options: {
            type: "object",
            required: ["time"],
            properties: { time: { type: "boolean", examples: [true] } },
          },
        },
      },
      {
        ...
        properties: {
          value: {
            type: "string",
            examples: ["This is short or long text in a Custom Field."],
          },
        },
      },
      {
        ...
        required: ["value"],
        properties: { value: { type: "number", examples: [-28] } },
      },
      {
        type: "object",
        ...
        required: ["value"],
        properties: { value: { type: "number", examples: [8000] } },
      },
      {
        type: "object",
        ...
        properties: {
          value: {
            ...
            properties: {
              ...
              rem: { type: "array", items: { type: "string" } },
            },
          },
        },
      },
      ...
      },
      {
        ...
        properties: {
          value: {
            type: "object",
            required: ["current"],
            properties: { current: { type: "number", examples: [20] } },
          },
        },
      },
      {
        ...
        properties: {
          value: {
            type: "array",
            items: { type: "string", examples: ["uuid1234", "uuid9876"] },
          },
        },
      },
      {
    ...
    properties: {
      ...
      tags: {
        ...
        items: {
          ...
          required: ["name"],
          type: "object",
          properties: { name: { type: "string", examples: ["tag1"] } },
        },
      },
      tid: { type: "string", examples: ["task_id"] },
      billable: { type: "boolean" },
...
const UpdateChatChannel = {
  body: {
    ...
    properties: {
      ...
      location: {
        description:
          "The updated location of the Channel: Space, Folder, or List",
        type: "object",
        required: ["id", "type"],
        properties: {
          id: {
      ...
      name: { type: "string", description: "The updated name of the Channel." },
      topic: {
        type: "string",
...
const UpdateComment = {
  body: {
    ...
    required: ["comment_text", "assignee", "resolved"],
    type: "object",
    properties: {
      comment_text: { type: "string", examples: ["Updated comment content"] },
      assignee: { type: "integer", contentEncoding: "int32", examples: [183] },
      group_assignee: {
        type: "integer",
        contentEncoding: "int32",
      ...
      resolved: { description: "", type: "boolean", examples: [true] },
    },
    $schema: "https://json-schema.org/draft/2020-12/schema",
  },
  metadata: {
...
const UpdateFolder = {
  body: {
    ...
    required: ["name"],
    type: "object",
    properties: { name: { type: "string", examples: ["Updated Folder Name"] } },
    $schema: "https://json-schema.org/draft/2020-12/schema",
  },
  metadata: {
    allOf: [
...
const UpdateGoal = {
  body: {
    ...
    type: "object",
    properties: {
      name: { type: "string", examples: ["Updated Goal Name"] },
      due_date: {
        type: "integer",
        contentEncoding: "int64",
        examples: [1568036964079],
      },
      description: { type: "string", examples: ["Updated Goal Description"] },
      rem_owners: {
        type: "array",
        items: { type: "integer", contentEncoding: "int32", examples: [183] },
        description: "Array of user IDs.",
      ...
      add_owners: {
        type: "array",
        items: { type: "integer", contentEncoding: "int32", examples: [184] },
        description: "Array of user IDs.",
      },
      color: { type: "string", examples: ["#32a852"] },
    },
...
const UpdateList = {
  body: {
    ...
    type: "object",
    properties: {
      name: { type: "string", examples: ["Updated List Name"] },
      content: { type: "string", examples: ["Updated List Content"] },
      markdown_content: {
        type: "string",
        description:
          "Use `markdown_content` instead of `content` to format your List description.",
      ...
      due_date_time: { type: "boolean", examples: [true] },
      priority: { type: "integer", contentEncoding: "int32", examples: [2] },
      assignee: { type: "string", examples: ["none"] },
      status: {
        description:
          "**Status** refers to the List color rather than the task Statuses available in the List.",
        type: "string",
      ...
      entries: {
        ...
        items: {
          ...
          properties: {
            id: {
              description:
                "The ID of user or user group (Team) you wish to give, remove, or edit permissions.",
              type: "string",
            },
            kind: {
...
const UpdateSpace = {
  body: {
    ...
    type: "object",
    properties: {
      name: { type: "string", examples: ["Updated Space Name"] },
      color: { type: "string", examples: ["#7B68EE"] },
      private: { type: "boolean" },
      admin_can_manage: {
        description:
...
const UpdateTask = {
  body: {
    ...
    properties: {
      ...
      name: { type: "string", examples: ["Updated Task Name"] },
      description: {
        description:
          'To clear the task description, include `Description` with `" "`.',
        type: "string",
        examples: ["Updated Task Content"],
      },
      markdown_content: {
        type: "string",
        description:
      ...
      status: { type: "string", examples: ["in progress"] },
      priority: { type: "integer", contentEncoding: "int32", examples: [3] },
      due_date: {
        type: "integer",
        contentEncoding: "int64",
        examples: [1508369194377],
        ...
        properties: {
          ...
          rem: {
            ...
            items: {
              type: "integer",
              contentEncoding: "int32",
              examples: ["dd01f92f-48ca-446d-88a1-0beb0e8f5f13"],
            },
            description: "",
          },
        },
...
const UpdateView = {
  body: {
    ...
    type: "object",
    properties: {
      name: { type: "string", examples: ["New View Name"] },
...
const UpdateWebhook = {
  body: {
    ...
    required: ["endpoint", "events", "status"],
    type: "object",
    properties: {
      endpoint: {
        type: "string",
