...
//   return (
//     <div>
//       <header className="bg-primary-500 hidden py-4 sm:block">
//         <div className="flex items-center justify-center gap-5">
//           <div
//             className={`p-2 ${view === "desktop" ? "bg-tapa-50 rounded-md" : ""}`}
//           >
//             <Monitor
//               size={35}
...
//           </div>
//           <div
//             className={`p-2 ${view == "tablet" ? "bg-tapa-50 rounded-md" : ""}`}
//           >
//             <Tablet
//               size={35}
...
//           </div>
//           <div
//             className={`p-2 ${view == "mobile" ? "bg-tapa-50 rounded-md" : ""}`}
//           >
//             <Smartphone
//               size={35}
